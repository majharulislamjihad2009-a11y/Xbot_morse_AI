...
> Note: All buttons use `INPUT_PULLUP` logic.  
> Each button is connected between the GPIO pin and **GND**.

| ESP8266 (NodeMCU) | GPIO  | Component | Component Pin |
|---|---:|---|---|
| 3V3 | — | OLED (SSD1306) | VCC |
| GND | — | OLED (SSD1306) | GND |
| D2 | GPIO4 | OLED (SSD1306) | SCL |
| D1 | GPIO5 | OLED (SSD1306) | SDA |
| D5 | GPIO14 | Button 1 (DOT) | Pin 1 |
| GND | — | Button 1 (DOT) | Pin 2 |
| D6 | GPIO12 | Button 2 (DASH) | Pin 1 |
| GND | — | Button 2 (DASH) | Pin 2 |
| D7 | GPIO13 | Button 3 (ACTION) | Pin 1 |
| GND | — | Button 3 (ACTION) | Pin 2 |
